...
- "open_to": string – what the candidate is open to, e.g. "Remote", "Hybrid", "Lahore, Pakistan", "Open to relocation". Extract only if explicitly stated or it is clear from the context. If not mentioned, use "Not mentioned".
